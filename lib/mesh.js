    ...
    _this._initializeDataLayer(instanceConfig, function (e) {
      ...
      async.series([
        ...
        if (e) {
          ...
          // if (_this.initializedServer) return _this._mesh.happn.server.stop(function (stopError) {
          //   if (stopError) _this.log.error('failure stopping happn server', stopError);
          //   else _this.initializedServer = false;
