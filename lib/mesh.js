...
Mesh.prototype.deferStartMethod = function(componentName, component, options, calls, call, done) {
  if (this._mesh.clusterClient) this._mesh.clusterClient.on(`${componentName}/startup/dependencies/satisfied`, () => {
  ...
  this._eachComponent(
    ...
    function(componentName, component, done) {
      ...
      if (!config.schema || !config.schema.methods || !config.schema.methods[options.methodName]) {
        ...
        if (options.methodCategory === 'startMethod') {
          if (config.dependencies && !emptyDependencies) {
            if (_this._mesh.clusterClient && _this._mesh.clusterClient.__implementors.addAndCheckDependencies(componentName, config.dependencies)) {
