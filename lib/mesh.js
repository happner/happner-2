...
Mesh.prototype.stop = Promise.promisify(function (options, callback) {
  ...
  this.__stopComponents(function (e) {
    ...
    logStopEvent('$$DEBUG', 'disconnecting local data client');

    // _this._mesh.data.disconnect(function (e) {
    //
    //   if (e) logStopEvent('error', 'failed to disconnect local data client', e);
...
Mesh.prototype._initializeDataLayer = function (config, callback) {
  ...
  _this._mesh.happn = DataLayer.create(_this, config,
    function (err, client) {
...
Mesh.prototype._filterConfig = function (config) {
  ...
  var sharedConfig = {name:config.name, version:this.version, happn:{}};
...
Mesh.prototype._initializeEndpoints = function (callback) {
  ...
  async.parallel(Object.keys(config.endpoints).map(function (endpointName) {
    ...
    return function (done) {
      ...
      if (!endpointConfig.config.keyPair) endpointConfig.config.keyPair = _this._mesh.happn.server.services.security._keyPair;
      ...
      Happn.client.create(endpointConfig, function (error, client) {
        ...
        client.onEvent('connection-ended', function (eventData) {
          ...
          _this.emit('endpoint-connection-ended', {
            endpointConfig:client.__endpointConfig,
            endpointName:client.__endpointName,
            eventData:eventData}
          );
        });
        ...
        client.onEvent('reconnect-scheduled', function (eventData) {
          ...
          _this.emit('endpoint-reconnect-scheduled', {
            endpointConfig:client.__endpointConfig,
            endpointName:client.__endpointName,
            eventData:eventData
          });
        ...
        client.onEvent('reconnect-successful', function (eventData) {
          ...
          process.nextTick(function () {
            ...
            _this.emit('endpoint-reconnect-successful', {
              endpointConfig: client.__endpointConfig,
              endpointName: client.__endpointName,
              eventData: eventData
            });
