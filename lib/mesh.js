...
Mesh.prototype._filterConfig = function (config) {
  ...
  var sharedConfig = {name:config.name, version:this.version, datalayer:{}};

  sharedConfig.datalayer.port = config.datalayer.port;
  sharedConfig.datalayer.secure = config.datalayer.secure;
  sharedConfig.datalayer.encryptPayloads = config.datalayer.encryptPayloads;
  sharedConfig.datalayer.setOptions = config.datalayer.setOptions;
  sharedConfig.datalayer.transport = config.datalayer.transport;
