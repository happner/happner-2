...
module.exports.create = function (mesh, happnServer, config, callback) {
  ...
  config.happn.inboundLayers.push(function (message, callback) {
    ...
    try {
      ...
      if (message.raw.action == 'on' && message.raw.path.indexOf('/_exchange/responses') >= 0) {

        var splitPath = message.raw.path.split('/');
  ...
  config.happn.outboundLayers.push(function (message, callback) {
