...
function Packager(mesh) {
  ...
  try{
    ...
    var script2 = normalize(mesh._mesh.datalayer.server.services.session.script);
    var script3 = dirname(require.resolve('happn-3'))  + sep + 'client.js';

    happnProtocol = require(require.resolve('happn-3').replace(sep + 'lib' + sep + 'index.js', '') + sep + 'package.json').protocol;
