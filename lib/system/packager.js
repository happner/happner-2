...
function Packager(mesh) {
  try {
    ...
    var script3 = normalize(__dirname + sep + 'shared' + sep + 'logger.js');
    var script4 = normalize(__dirname + sep + 'shared' + sep + 'promisify.js');
    var script5 = normalize(__dirname + sep + 'shared' + sep + 'mesh-error.js');
    var script6 = normalize(__dirname + sep + 'shared' + sep + 'messenger.js');
    var script7 = normalize(__dirname + sep + 'shared' + sep + 'internals.js');
    var script8 = normalize(__dirname + sep + 'shared' + sep + 'mesh-client.js');

    var script9 = dirname(require.resolve('happner-client')) + sep + 'lib' + sep + 'semver.js';
    var script10 =
      dirname(require.resolve('happner-client')) +
      sep +
      'lib' +
      sep +
      'builders' +
    ...
    var script13 =
      ...
      'providers' +
      sep +
      'operations-provider.js';
    var script14 =
      dirname(require.resolve('happner-client')) + sep + 'lib' + sep + 'happner-client.js';
