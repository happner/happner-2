...
ComponentInstance.prototype.secureData = function (meshData, componentName) {
  ...
  securedMeshData.increment = function (path, guage, increment, callback) {
    ...
    return meshData.increment(this.getPath(path), guage, increment, callback);
  };
