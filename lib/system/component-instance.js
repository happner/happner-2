...
ComponentInstance.prototype.secureExchangeBoundToOriginMethods = function(component, boundComponent, origin){
  ...
  Object.keys(component).forEach(function(methodName){
    ...
    if (typeof component[methodName] == 'function') {
      boundComponent[methodName] = component[methodName].bind({$self:component[methodName], $origin: origin});
      return;
    }

    if (typeof component[methodName] == 'object') {
      boundComponent[methodName] = {};
      return _this.secureExchangeBoundToOriginMethods(component[methodName], boundComponent[methodName], origin);
    }
...
//TODO: LRU cache by origin.username? possibly remove
ComponentInstance.prototype.secureExchangeBoundToOrigin = function (exchange, origin) {

  const boundExchange = {};
  const _this = this;

  Object.keys(exchange).forEach(function(componentName){
    boundExchange[componentName] = {};
    _this.secureExchangeBoundToOriginMethods(exchange[componentName], boundExchange[componentName], origin);
  });
...
ComponentInstance.prototype.secureEventBoundToOrigin = function (event, origin) {
  ...
  Object.keys(event).forEach(function(componentName){
    ...
    //endpoint, domain, componentName, origin
...
//TODO: LRU cache by origin.username?
  ...
  Object.defineProperty(_this, '__authorizeOriginMethod', {
    get: function () {
      return function(methodName, origin, callback){
        ...
        mesh._mesh.happn.server.services.security.__getOnBehalfOfSession({user:{username:'_ADMIN'}}, origin.username, function(e, originSession){
...
ComponentInstance.prototype._getWebOrigin = function (mesh, params) {
  ...
  return mesh.happn.server.services.security.sessionFromRequest(params[0], {cookieName:cookieName});
};
...
ComponentInstance.prototype._attach = function (config, mesh, callback) {
  ...
  _this.emit = function (key, data, options, callback) {
    ...
    options.meta = {componentVersion: _this.module.version};
