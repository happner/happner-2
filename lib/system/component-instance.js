...
ComponentInstance.prototype.__callBackWithError = function(category, message, callback, noStack) {
  const error = new Error(message);

  if (noStack) this.log.warn(`${category}:${message}`);
  else this.log.warn(category, error);
