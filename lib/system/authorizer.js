...
module.exports = class Authorizer {
  constructor(securityService, sessionService, adminClient) {
    this.securityService = securityService;
    this.sessionService = sessionService;
    this.adminClient = adminClient;
  }
  static create(securityService, sessionService, adminClient) {
    return new Authorizer(securityService, sessionService, adminClient);
  }
