;(function (isBrowser) {
  ...
  MeshClient.prototype.updateSession = function(){
  ...
  MeshClient.prototype.disconnect = function (cb, opts) {

    try {

      if (this.clientInstance && this.clientInstance.data){
        if (typeof cb == 'function') return this.clientInstance.data.disconnect(cb);
        return this.clientInstance.data.disconnect();
      }
