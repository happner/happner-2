(function(isBrowser) {
  ...
  function MeshClient /* opts */() {
    ...
    if (typeof callback === 'function') {
      ...
      return initialize(this, opts, (e, instance) => {
  ...
  var initialize = function(instance, opts, callback) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (instance.data && [1, 4, 5, 6, 7].indexOf(instance.data.status) >= 0)
        instance.data.disconnect(createClient);
      else createClient();

      function createClient() {
        MeshHappnClient.create(
          { config: config, info: opts.info, Logger: opts.log, reconnect: opts.reconnect },
          function(e, fbclient) {
            if (e) {
