(function(isBrowser) {
  ...
  Internals._decoupleEventAPILayer = function(eventAPI) {
    ...
    eventAPI.$once = (parameters, handler) => {
      return Internals.getEndpoint(parameters, eventAPI).once(
        parameters.path,
        parameters.options,
        handler
      );
    ...
    eventAPI.$off = parameters => {
      return Internals.getEndpoint(parameters, eventAPI).off(parameters.id, parameters.options);
    };
    eventAPI.$offPath = parameters => {
      return Internals.getEndpoint(parameters, eventAPI).offPath(
        parameters.path,
        parameters.options
      );
    };
