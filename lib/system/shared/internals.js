    ...
    // Filter out components that are already initialized in the messenger.
      ...
      .map(function (componentName) {
        ...
        if (endpointName == _this._mesh.config.name) {
          ...
          exchangeAPI[componentName].__version = componentDesciption.version;
        }
        ...
        Object.keys(componentDesciption.methods)
          ...
          .forEach(function (methodName) {
            ...
            if (endpointName == _this._mesh.config.name) {
              ...
              exchangeAPI[componentName].__localComponent = true;
            }
          });
      ...
      .forEach(function (componentName) {
        ...
        var subscriber = {
          ...
          once: function(key, handler, onceDone){
            ...
            endpoint.data.on(eventKey + key, {event_type: 'set', count:1}, handler, onceDone);
          },
