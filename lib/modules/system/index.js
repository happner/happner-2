...
function System() {
  ...
  _this.deactivateStatistics = function ($happn) {
    ...
    if (_this.__statsIntervalPointer) clearInterval(_this.__statsIntervalPointer);
  };
  ...
  _this.getStats = function ($happn, measureInterval, callback) {
    ...
    if (typeof measureInterval === 'function') {
      callback = measureInterval;
    ...
    try {
      ...
      var _this = this;
      var upTime = Date.now() - _this.__systemUp;
