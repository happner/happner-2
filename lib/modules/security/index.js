...
Security.prototype.upsertLookupPermission = async function(group, permission) {
  return this.__securityService.upsertLookupPermission(group, permission);
};

Security.prototype.removeLookupPermission = async function(group, permission) {
  return this.__securityService.removeLookupPermission(group, permission);
};

Security.prototype.unlinkLookupTable = async function(table, group) {
  return this.__securityService.upsertLookupTable(table);
};
