...
Security.prototype.initialize = function ($happn, callback) {
  ...
  try {
    ...
    _this.__pubsubService = $happn._mesh.happn.server.services.pubsub;
...
Security.prototype.__validateRequest = function (methodName, callArguments, callback) {
  ...
  if (!this.__initialized)
    return callback(new Error('security module not initialized, is your happn configured to be secure?'));
