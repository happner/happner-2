      ...
      _this.__authorize(req, res, $happn, $origin, '/' + methodURI, function() {
        ...
        process.nextTick(function() {
          ...
          methodDescription.parameters.map(function(parameter) {
            ...
            if (body.parameters[parameter.name] || body.parameters[parameter.name] === 0) args.push(body.parameters[parameter.name]);
            else args.push(null);
          });
...
Rest.prototype.__wrapExchange = util.promisify(function($happn, callback) {
  var _this = this;
  ...
  _this.__exchangeDescription = cleanDescription($happn._mesh.description, [
    $happn._mesh.description.name
  ]);
