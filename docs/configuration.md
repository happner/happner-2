...
When specifying `schema.initMethod`, if the corresponding startmethod is not defined in the schema it is assumed that the start method takes a callback as the only argument.
