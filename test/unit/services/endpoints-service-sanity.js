  ...
  function() {
          ...
          schema: {
            ...
            methods: {
              get: {
                ...
                callback: {
                  parameters: [{ name: 'error', type: 'error' }, { name: 'response' }]
                }
              },
              set: {
                alias: 'PUT',
    ...
    it('requires, initializes the endpoint service with 2 endpoints, fails creating client', function(done) {
      ...
      var endpointService = new EndpointService(
        ...
        mockExchangeAPI(),
        mockEventAPI(),
        mockHappn('failed creating happn')
      );
    ...
    it('requires, initializes the endpoint service with 2 endpoints, fails getting description', function(done) {
      ...
      var endpointService = new EndpointService(
        ...
        mockExchangeAPI(),
        mockEventAPI(),
        mockHappn(null, 'description get error')
      );
      ...
      endpointService.initialize(
        ...
        function(e) {
          expect(e.toString()).to.be(
            'Error: endpoint remoteMesh1 returned description for crapBag'
          );
          done();
        }
      );
    ...
    it('requires, initializes and stops the endpoint service with a disconnection error', function(done) {
      ...
      var endpointService = new EndpointService(
        ...
        mockExchangeAPI(),
        mockEventAPI(),
        mockHappn(null, null, null, null, null, 'test error')
      );
