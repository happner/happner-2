describe('browsertest_03_events', function() {
  ...
  it('does a variable depth subscribe, default depth', function(done){
    ...
    client.event.testComponent2.on('variable-depth/event/**', function(data, meta){
      emitted.push(meta.path);
    }, function(e){
      if (e) return done(e);
      client.exchange.testComponent2.emitEvent('variable-depth/event/1', {key: 'value'}, function(e){
        if (e) return done(e);
      });
      client.exchange.testComponent2.emitEvent('variable-depth/event/1/2', {key: 'value'}, function(e){
        if (e) return done(e);
      });
      client.exchange.testComponent2.emitEvent('variable-depth/event/1/2/3', {key: 'value'}, function(e){
        if (e) return done(e);
      });
      client.exchange.testComponent2.emitEvent('variable-depth/event/1/2/3/4', {key: 'value'}, function(e){
        if (e) return done(e);
      });
      client.exchange.testComponent2.emitEvent('variable-depth/event/1/2/3/4/5/6', {key: 'value'}, function(e){
        if (e) return done(e);
      });
