...
describe(
  ...
  function() {
    ...
    it('can inject $happn and $origin in forward order', function(done) {
      cookieRequest('http://localhost:10000/middlewareTest/injectForwardOrder', function(
        e,
        res,
        body
      ) {
    ...
    it('can inject $origin and $happn in reverse order', function(done) {
      cookieRequest('http://localhost:10000/middlewareTest/injectReverseOrder', function(
        e,
        res,
        body
      ) {
