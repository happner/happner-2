...
describe(path.basename(__filename), function () {
  ...
  it('does a set on the datalayer component', function (done) {
    ...
    testClient.exchange.websocket_client.data.set('/websocket_client/set', {"val": "set"}, function (e, result) {
  ...
  it('does a get on the datalayer component', function (done) {
    ...
    testClient.exchange.websocket_client.data.set('/websocket_client/get', {"val": "get"}, function (e, result) {

      if (e) return done(e);

      expect(result.val).to.be("get");

      testClient.exchange.websocket_client.data.get('/websocket_client/get', {}, function (e, getresult) {
  ...
  it('does a delete on the datalayer component', function (done) {
    ...
    testClient.exchange.websocket_client.data.set('/websocket_client/delete', {"val": "delete"}, function (e, result) {

      if (e) return done(e);

      expect(result.val).to.be("delete");

      testClient.exchange.websocket_client.data.get('/websocket_client/delete', {}, function (e, getresult) {

        if (e) return done(e);

        expect(getresult.val).to.be("delete");

        testClient.exchange.websocket_client.data.remove('/websocket_client/delete', {}, function (e, removeresult) {

          if (e) return done(e);

          testClient.exchange.websocket_client.data.get('/websocket_client/delete', {}, function (e, getremovedresult) {
