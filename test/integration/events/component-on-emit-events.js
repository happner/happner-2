describe(
  ...
  function() {
    ...
    var libFolder =
      ...
      path.sep +
      ['test', '__fixtures', 'test', 'integration', 'events'].join(path.sep);
   ...
   */
    ...
    it('tests an emit using the default transactional consistency, checks the on-emit-ok event', function(done) {
      client.exchange.component1.causeEmit(
    ...
    it('tests a failing event emit makes it to the on-emit-error event', function(done) {
      client.exchange.component1.causeEmitError(
        'default-transactional',
        'default-transactional',
        { consistency: 0 },
        function(e) {
    ...
    it('tests off([string] across components and clients', function(done) {
      ...
      client.data.on(
        '/_events/*/component1/test-concurrent-event',
        function(data) {
        ...
        function(e) {
          ...
          client.exchange.component1.causeEmitConcurrent(
    ...
    it('tests off([listenerId] across components and clients', function(done) {
      ...
      client.data.on(
        '/_events/*/component1/test-listener-id',
        function(data) {
          clientEvents.push(data);
        },
