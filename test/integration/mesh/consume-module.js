    ...
    it('starts a local mesh, with a single component that wraps the happn client module and compares the response with a happn client instantiated outside of the mesh', function(done) {
      ...
      require('happn-3').client.create({ config: { host: 'localhost', secret: 'mesh' } }, function(
        ...
        client.set('/mytest/678687', { test: 'test1' }, {}, function(e, directClientResponse) {
          ...
          mesh.exchange.happnClient.set('/mytest/678687', { test: 'test1' }, {}, function(
            e,
            response
          ) {
            ...
            mesh.exchange.testMesh.happnClient.set(
              '/mytest/678687',
              { test: 'test1' },
              {},
              function(e, response) {
                ...
                mesh.post('/happnClient/set', '/mytest/678687', { test: 'test1' }, {}, function(
                  e,
                  response
                ) {
                  if (e) return done(e);
                  ...
                  //test aliases
                  mesh.exchange.testMesh.happnClient.PUT(
                    '/mytest/678687',
                    { test: 'test1' },
                    {},
                    function(e, response) {
