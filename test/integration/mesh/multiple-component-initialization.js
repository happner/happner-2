...
describe(path.basename(__filename), function () {
  ...
  before(function (done) {
    ...
    var config = {
      ...
      modules: {
        one_class: {
          path: libFolder + '3-one_class-module.js',
          construct: {}
        },
        ...
        two_sync: {
          path: libFolder + '3-two_sync-module.js'
        },
        ...
        three_async: {
          path: libFolder + '3-three_async-module.js',
          create: {
            type: 'async',
            callback: {
        ...
        three_async_with_params: {
          path: libFolder + '3-three_async_with_params-module.js',
          create: {
            type: 'async',
            name: 'create',
            parameters: [
        ...
        four_object: {
          path: libFolder + '3-four_object-module.js'
        },
        five_hidden_class: {
          path: libFolder + '3-five_hidden_class-module.js'
        },
        ...
        six_nested_class: {
          path: libFolder + '3-six_nested_class-module.js',
          construct: {
            name: 'Thing'
          }
        },
        six_nested_class_with_params: {
          path: libFolder + '3-six_nested_class_with_params-module.js',
          construct: {
            name: 'Thing',
            parameters: [
              {value: '1'},
