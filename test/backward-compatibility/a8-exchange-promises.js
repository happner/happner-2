...
describe('a8 - exchange supports promises', function () {
  ...
  it('supports non-promises in the exchange', function (done) {
    ...
    testClient.exchange.component.methodName1({number: 1}, function (err, res) {
  ...
  it('supports promises in the exchange', function (done) {
    ...
    testClient.exchange.component.methodName1({number: 1})
  ...
  it('the promise implementation supports .catch from callback error', function (done) {
    ...
    testClient.exchange.component.methodName1({errorAs: 'callback'})
      ...
      .catch(function (err) {
        ...
        expect(errMessage).to.be('Error: THIS IS JUST A TEST');
        done();
      })
  ...
  it('the promise implementation supports .catch from thrown error', function (done) {
    ...
    testClient.exchange.component.methodName1({errorAs: 'throw'})
  ...
  it('supports non-promises on the alias', function (done) {
    ...
    testClient.exchange.component.ancientmoth({number: 1}, function (err, res) {
  ...
  it('supports promises on the alias', function (done) {
    ...
    testClient.exchange.component.ancientmoth({number: 1})
  ...
  it('supports calling a synchronous method and getting a promise back', function (done) {
    ...
    testClient.exchange.component.synchronousMethod(1, 2)
  ...
  it('supports calling a synchronous method with $happn and $origin and getting a promise back', function (done) {
    ...
    testClient.exchange.component.synchronousMethodHappnOrigin(1, 2)
  ...
  it('supports exposing a promise on the exchange', function (done) {
    ...
    testClient.exchange.component.promiseMethod({number: 1})
  ...
  it('supports calling a promise from a promise on the exchange', function (done) {
    ...
    testClient.exchange.component.promisePromiseCaller({number: 1})
  ...
  it('supports calling a promise from a method on the exchange', function (done) {
    ...
    testClient.exchange.component.promiseCaller({number: 1})
  ...
  it('supports returning a promise from a method on the exchange', function (done) {
    ...
    testClient.exchange.component.promiseReturner({number: 1})
      .then(function (res) {
        expect(res.number).to.be(2);
        done();
      })
  ...
  it('supports returning a promise from a method on the exchange with no callback', function (done) {
    ...
    testClient.exchange.component.promiseReturnerNoCallback({number: 1})
      .then(function (res) {
        expect(res.number).to.be(2);
        done();
      })
  ...
  it('supports returning a promise from a method on the exchange that throws an error', function (done) {
    ...
    testClient.exchange.component.promiseReturnerNoCallback({number: 1, errorAs: 'throw'})
      .then(function () {
      ...
      .catch(function (err) {
        ...
        expect(errMessage).to.be('Error: THIS IS JUST A TEST THAT THROWS AN ERROR');
  ...
  it('supports returning a promise from a method on the exchange that callbacks an error', function (done) {
    ...
    testClient.exchange.component.promiseReturnerNoCallback({number: 1, errorAs: 'callback'})
      .then(function () {
        done(new Error('should not get here'));
      })
      .catch(function (err) {
        ...
        expect(errMessage).to.be('Error: THIS IS JUST A TEST WITH CALLBACK ERROR');
  ...
  it('does not time out a sync function', function (done) {
    ...
    testClient.exchange.component.fireAndForget({number: 1})
      .then(function (res) {
  ...
  it('does not fire a callback twice', function (done) {
    ...
    testClient.exchange.component.callCallbackTwice({number: 1}, function (err, result) {
      expect(result.number).to.be(2);
      setTimeout(done, 500);
    });
  });
