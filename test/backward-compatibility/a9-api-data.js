...
///events/testComponent2Component/component1/maximum-pings-reached
  ...
  before(function (done) {
    var _this = this;
    Mesh2.create(config).then(function (mesh) {
  ...
  it('stores some data on component1, we look at the output from happn', function (done) {
    ...
    testClient.exchange.component1.storeData('/test/a9-api-data', {"testprop1": "testval1"}, {}, function (e, result) {
  ...
  it('checks the on count on component1 must be greater than 0', function (done) {
    ...
    testClient.exchange.component1.getOnCount(function (e, result) {
